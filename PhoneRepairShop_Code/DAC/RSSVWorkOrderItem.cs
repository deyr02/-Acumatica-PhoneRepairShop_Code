...
namespace PhoneRepairShop
{
  ...
  public class RSSVWorkOrderItem : IBqlTable
  {
    ...
    [PXDefault(typeof(RSSVWorkOrder.orderNbr))]
    [PXParent(
    ...
    [PXStringList(
            new string[]
            {
                Helper.Constants.RepairItemTypeConstants.Battery,
                Helper.Constants.RepairItemTypeConstants.Screen,
                Helper.Constants.RepairItemTypeConstants.ScreenCover,
                Helper.Constants.RepairItemTypeConstants.BackCover,
                Helper.Constants.RepairItemTypeConstants.Motherboard
            }, 
            new string[]
            {
   ...
   [PXRestrictor(
           typeof(
            ...
            Helper.Messages.StockItemIncorrectRepairItemType,
