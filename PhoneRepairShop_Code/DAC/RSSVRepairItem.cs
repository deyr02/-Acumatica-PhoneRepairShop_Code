...
using PX.Objects.IN;
using static PhoneRepairShop.Helper.Constants;
...
namespace PhoneRepairShop
{
    ...
    public class RSSVRepairItem : IBqlTable
    {
        ...
        [PXStringList(
            ...
            new string[]
            {
                Helper.Messages.Battery,
                Helper.Messages.Screen,
                Helper.Messages.ScreenCover,
                Helper.Messages.BackCover,
                Helper.Messages.Motherboard
            })]
        ...
        #region 
        [PXRestrictor(typeof(Where<InventoryItemExt.usrRepairItem.IsEqual<True>
            .And<InventoryItemExt.usrRepairItemType.IsEqual<RSSVRepairItem.repairItemType.FromCurrent>>
            .And<RSSVRepairItem.repairItemType.FromCurrent.IsNotNull>.Or<InventoryItemExt.usrRepairItem.IsEqual<True>
            .And<RSSVRepairItem.repairItemType.FromCurrent.IsNull>>>), Helper.Messages.StockItemIncorrectRepairItemType, typeof(RSSVRepairItem.repairItemType))]
        [Inventory]
